...
- Ý dùng được: | 1 | Lặp lại | Xuất CSV số liệu tuần từ Meta, Google, TikTok Ads ghép vào Sheet | An, Account Manager | Mất 60 phút mỗi sáng thứ Hai |
| 2 | Lặp lại | Copy bảng số liệu và biểu đồ từ Sheet vào slide báo cáo tuần | An | 4 slide template, lặp lại đều đặn mỗi tuần |
| 3 | Lặp lại | Gắn mã UTM tracking thủ công cho từng link bài quảng cáo trước khi bật chiến dịch | An, Data team | 20–30 link/tuần, mất 30 phút rà soát |
| 4 | Tốn thời gian | Viết 3–5 gạch đầu dòng nhận xét và giải thích nguyên nhân biến động CPA cho 4 nhãn hàng | An, Brand Manager | Mất 90–120 phút mỗi sáng thứ Hai |
| 5 | Tốn thời gian | Tính toán ngân sách còn lại trong tháng và soạn phương án tái phân bổ cho tuần tới | An, Media Lead | 30–45 phút/tuần |
...
| 9 | Pain từ người khác | Brand Marketing Manager nhắn tin giục vì 11:30 chưa nhận được báo cáo để kịp họp nội bộ đầu tuần | Brand Manager, An | Trễ hẹn gửi báo cáo 2 lần trong tháng qua |
| 10 | Pain từ người khác | Creative Designer phàn nàn vì không rõ mẫu video/banner nào chạy kém để làm mẫu mới thay thế | Designer, An | Hỏi đi hỏi lại 2–3 lần/tuần trên Slack |
- Ý bỏ vì không phải pain thật: * **Bật/tắt thủ công campaign Flash Sale lúc 23:00:** Bị loại vì đây là bài toán scheduler/rule thuần túy (tính năng hẹn giờ có sẵn trên Ads Manager), không có độ phức tạp về tư duy hay ngôn ngữ để cần đến giải pháp sâu.
...
Thời điểm / bối cảnh:09:30 – 11:30 sáng thứ Hai hàng tuần, ngay sau khi hoàn thành bước đồng bộ số liệu thô từ các nền tảng quảng cáo (Meta, Google, TikTok Ads).
...
Bottleneck:Bước 4 — Viết narrative từ dữ liệu số mất khoảng 60 phút (15 phút/nhãn hàng) và thường xuyên bị "blank page syndrome" khi phải chuyển đổi các chỉ số kỹ thuật khô khan (CTR, CPC, CPA) thành insight kinh doanh có giá trị hành động cho khách hàng.

Impact:- Cá nhân: Mất 145 phút vào khung giờ áp lực nhất đầu tuần; 2 lần trong tháng qua bị trễ deadline 11:30 do tắc ở khâu viết.
